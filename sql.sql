...
select * from Idiomas;
go
INSERT INTO Regiones (Nombre) VALUES ('Am�rica del Norte'), ('Europa'), ('Asia'), ('Am�rica Latina');
GO

INSERT INTO Idiomas (Nombre, Codigo) VALUES ('Espa�ol', 'ES'), ('Ingl�s', 'EN'), ('Franc�s', 'FR'), ('Alem�n', 'DE');
GO
